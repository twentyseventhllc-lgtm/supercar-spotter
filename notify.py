...
def notify_catch(action, image_path):
    """Push one notification the first time a track is caught. Network failures
    are swallowed (a missed ping must never crash the live loop)."""
